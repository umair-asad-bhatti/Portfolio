...
export default function ThemeController() {
    ...
    useEffect(() => {
        ...
        console.log(html);
        html.setAttribute('data-theme', theme == 'light' ? THEMES.light : THEMES.dark)
    }, [theme])
    ...
    return (
        <div className="">
            <label className="swap swap-rotate">
                ...
                <input onClick={() => theme == 'light' ? setTheme('dark') : setTheme('light')} type="checkbox" className="theme-controller" value="forest" />
